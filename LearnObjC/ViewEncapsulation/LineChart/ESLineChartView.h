...
@class ESLineChartDataItem;
@class ESLineChartData;

typedef ESLineChartDataItem *(^ESLineChartDataGetter)(NSUInteger item);
typedef void(^ESLineChartSelectedItem)(ESLineChartData * data, NSUInteger item, CGPoint positionInChart);
typedef void(^ESLineChartDeselectedItem)();


@interface ESLineChartDataItem : NSObject
...
@interface ESLineChartData : NSObject
...
@property (copy) ESLineChartDataGetter getData;
...
@property (copy) ESLineChartSelectedItem selectedItemCallback; /// Called whenever a data point is selected
@property (copy) ESLineChartDeselectedItem deselectedItemCallback; /// Called after a data point is deselected and before the next `selected` callback
